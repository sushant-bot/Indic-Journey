...
export default function TempleTourPunePage() {
  const itinerary = [
    {
      time: "07:00 AM",
    ...
    },
    {
      ...
      description: "Begin with the ancient 8th-century rock-cut cave temple dedicated to Lord Shiva",
      duration: "45 minutes",
    },
    {
      time: "08:00 AM",
      location: "Omkareshwar Temple",
      description: "Visit this beautiful temple showcasing traditional Marathi architecture",
      duration: "30 minutes",
    },
    {
      time: "08:30 AM",
      location: "Trishundya Ganpati",
      description: "Explore one of Pune's most revered Ganpati temples with rich cultural significance",
      duration: "30 minutes",
    },
    {
      time: "09:00 AM",
      location: "Sarasbaug Ganpati Temple",
      description: "Visit this famous Ganpati temple known for its grand celebrations",
      duration: "30 minutes",
    },
    {
      time: "09:30 AM",
      location: "Baneshwar Cave Temple",
      description: "Discover another ancient rock-cut temple with intricate carvings",
      duration: "30 minutes",
    },
    {
      time: "10:00 AM",
      location: "Someshwar Temple",
      description: "Experience the spiritual ambiance of this historic Shiva temple",
      duration: "30 minutes",
    },
    {
      time: "10:30 AM",
      location: "Devdeveshwar Temple at Parvati (Optional)",
      description: "Optional small hike to this hilltop temple offering panoramic city views",
      duration: "60 minutes",
    },
    {
      time: "11:30 AM",
  ...
  const highlights = [
    "Rock-cut to carved to contemporary temple architecture",
    "Temples representing every period of Common Era",
    "Spiritual and cultural significance of each temple",
    "Stories and legends behind famous temples",
    "Optional hiking experience at Parvati Hill",
    "Understanding of local religious practices",
  ]
  ...
  const importantNotes = [
    ...
    "Comfortable walking shoes recommended for optional hike",
    "Early morning start for peaceful temple experience",
  ...
  const templeFeatures = [
    {
      title: "Ancient Rock-Cut Temples",
      description: "8th-century cave temples carved from solid rock",
      icon: Mountain,
    },
    {
      title: "Traditional Architecture",
      description: "Marathi and Dravidian architectural styles",
      icon: Building,
    },
    {
      title: "Spiritual Significance",
      description: "Active temples with daily rituals and prayers",
      icon: Heart,
    },
    {
      title: "Cultural Heritage",
      description: "Temples preserving centuries of traditions",
      icon: Sparkles,
    },
  ]
      ...
      <section className="relative py-20 lg:py-28 overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center text-white">
            ...
            <h1 className="text-4xl lg:text-6xl font-bold mb-6 font-poppins drop-shadow-lg">Temple Tour of Pune</h1>

            <p className="text-lg lg:text-xl mb-8 font-open-sans max-w-3xl mx-auto leading-relaxed opacity-95">
              Discover Pune's spiritual heritage through famous temples that preserve the city's history and culture.
              Experience rock-cut to contemporary architecture representing every period of the Common Era.
            </p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold mb-4 font-poppins">Temple Architecture & Heritage</h2>
            <p className="text-gray-600 max-w-3xl mx-auto font-open-sans">
              Pune's temples represent a rich tapestry of architectural styles and spiritual traditions, each telling a
              unique story of the city's cultural evolution.
            </p>
          </div>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="grid lg:grid-cols-3 gap-8">
              ...
              <div className="lg:col-span-2">
                <div className="mb-8">
                  <h2 className="text-3xl font-bold mb-4 font-poppins">About This Spiritual Journey</h2>
                  <p className="text-gray-600 font-open-sans leading-relaxed text-lg">
                    The city of Pune is famous for its temples that have played an important part in preserving the
                    history and culture of the city. They act as a common thread that binds the people of this city to
                    their roots and are decisive in keeping them intact. Most of these famous temples see more than five
                    thousand visitors a day, and the number goes up by 15 to 20 times during festivities. From Rock Cut
                    to Carved to Contemporary Architecture, they represent almost every time period of the Common Era.
                  </p>
                </div>
                      ...
                      <Card key={index} className="border-l-4 border-l-orange-500">
                        <CardContent className="p-6">
                          <div className="flex flex-col md:flex-row md:items-center justify-between mb-3">
                            ...
                            {item.location.includes("Optional") && (
      ...
      <section className="py-16 bg-gradient-to-r from-orange-500 to-red-600">
        <div className="container mx-auto px-4 text-center">
          <div className="max-w-3xl mx-auto text-white">
            <h2 className="text-3xl lg:text-4xl font-bold mb-4 font-poppins">Ready for a Spiritual Journey?</h2>
            <p className="text-xl mb-8 font-open-sans opacity-95">
              Experience the divine heritage of Pune through its magnificent temples and spiritual traditions.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/contact">
                <Button className="bg-white text-orange-600 hover:bg-orange-50 hover:text-orange-700 px-8 py-3 text-lg rounded-full font-semibold shadow-lg hover:shadow-xl transition-all duration-300">
                  Book This Temple Tour
                  <ArrowRight className="ml-2 h-5 w-5" />
                </Button>
              </Link>
